...
use crate::wit::cst::{self, NAPINodeExtensions, NonterminalNode, TerminalNode};
use crate::wit::{text_index, EdgeLabel, NonterminalKind, RustCursor, TerminalKind};

#[napi(namespace = "cursor")]
pub struct Cursor(pub(crate) RustCursor);
