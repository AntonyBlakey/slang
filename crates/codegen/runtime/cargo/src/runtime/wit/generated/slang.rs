        ...
        pub mod kinds {
            ...
            impl ::core::fmt::Debug for NonterminalKind {
                fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
                    match self {
                        NonterminalKind::Stub1 => f.debug_tuple("NonterminalKind::Stub1").finish(),
                        NonterminalKind::Stub2 => f.debug_tuple("NonterminalKind::Stub2").finish(),
                        NonterminalKind::Stub3 => f.debug_tuple("NonterminalKind::Stub3").finish(),
                    }
                }
            }
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa0\x1c\x01A\x02\x01\
...
minal-kind\x03\0\x04\x03\x01\x17nomic:slang/kinds@1.0.0\x05\0\x01B\x04\x01r\x04\x04\
...
\0\0\x0aedge-label\x02\x03\0\x01\x0atext-index\x02\x03\0\x01\x0atext-range\x01Bj\
...
\x04self\x19\0s\x04\0\x20[method]nonterminal-node.to-json\x01\x1f\x04\0\x20[meth\
od]nonterminal-node.unparse\x01\x1f\x01h\x0b\x01@\x01\x04self\x20\0\x03\x04\0\x1a\
[method]terminal-node.kind\x01!\x01@\x01\x04self\x20\0\x07\x04\0\x1e[method]term\
inal-node.text-len\x01\"\x01@\x01\x04self\x20\0s\x04\0\x1a[method]terminal-node.\
text\x01#\x04\0\x1d[method]terminal-node.to-json\x01#\x01@\x02\x04self\x20\x0bte\
xt-offset\x07\0\x12\x04\0#[method]terminal-node.create-cursor\x01$\x01h\x10\x01@\
\x01\x04self%\x01\0\x04\0\x14[method]cursor.reset\x01&\x04\0\x17[method]cursor.c\
omplete\x01&\x01@\x01\x04self%\0\x7f\x04\0\x1b[method]cursor.is-completed\x01'\x01\
@\x01\x04self%\0\x12\x04\0\x14[method]cursor.clone\x01(\x04\0\x14[method]cursor.\
spawn\x01(\x01@\x01\x04self%\0\x0f\x04\0\x13[method]cursor.node\x01)\x01k\x05\x01\
@\x01\x04self%\0*\x04\0\x14[method]cursor.label\x01+\x01@\x01\x04self%\0\x07\x04\
\0\x1a[method]cursor.text-offset\x01,\x01@\x01\x04self%\0\x09\x04\0\x19[method]c\
ursor.text-range\x01-\x01@\x01\x04self%\0y\x04\0\x14[method]cursor.depth\x01.\x01\
p\x0c\x01@\x01\x04self%\0/\x04\0\x18[method]cursor.ancestors\x010\x04\0\x19[meth\
od]cursor.go-to-next\x01'\x04\0([method]cursor.go-to-next-non-descendent\x01'\x04\
\0\x1d[method]cursor.go-to-previous\x01'\x04\0\x1b[method]cursor.go-to-parent\x01\
'\x04\0\x20[method]cursor.go-to-first-child\x01'\x04\0\x1f[method]cursor.go-to-l\
ast-child\x01'\x01@\x02\x04self%\x0cchild-numbery\0\x7f\x04\0\x1e[method]cursor.\
go-to-nth-child\x011\x04\0![method]cursor.go-to-next-sibling\x01'\x04\0%[method]\
cursor.go-to-previous-sibling\x01'\x04\0\"[method]cursor.go-to-next-terminal\x01\
'\x01@\x02\x04self%\x04kind\x03\0\x7f\x04\0,[method]cursor.go-to-next-terminal-w\
ith-kind\x012\x01p\x03\x01@\x02\x04self%\x05kinds3\0\x7f\x04\0-[method]cursor.go\
-to-next-terminal-with-kinds\x014\x04\0%[method]cursor.go-to-next-nonterminal\x01\
'\x01@\x02\x04self%\x04kind\x01\0\x7f\x04\0/[method]cursor.go-to-next-nontermina\
l-with-kind\x015\x01p\x01\x01@\x02\x04self%\x05kinds6\0\x7f\x04\00[method]cursor\
.go-to-next-nonterminal-with-kinds\x017\x01i\x11\x01p8\x01i\x18\x01@\x02\x04self\
%\x07queries9\0:\x04\0\x14[method]cursor.query\x01;\x01j\x018\0\x01@\x01\x04text\
s\0<\x04\0\x13[static]query.parse\x01=\x01h\x18\x01k\x17\x01j\x01?\0\x01@\x01\x04\
self>\0\xc0\0\x04\0![method]query-match-iterator.next\x01A\x04\x01\x15nomic:slan\
g/cst@1.0.0\x05\x07\x01B\x0c\x02\x03\x02\x01\x06\x04\0\x0atext-range\x03\0\0\x01\
m\x04\x05error\x07warning\x0binformation\x04hint\x04\0\x08severity\x03\0\x02\x04\
\0\x0adiagnostic\x03\x01\x01h\x04\x01@\x01\x04self\x05\0\x03\x04\0\x1b[method]di\
agnostic.severity\x01\x06\x01@\x01\x04self\x05\0\x01\x04\0\x1d[method]diagnostic\
.text-range\x01\x07\x01@\x01\x04self\x05\0s\x04\0\x1a[method]diagnostic.message\x01\
\x08\x04\x01\x1cnomic:slang/diagnostic@1.0.0\x05\x08\x02\x03\0\x02\x04node\x02\x03\
